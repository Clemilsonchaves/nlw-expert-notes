...
export function NewNoteCard( {onNoteCreated}: NewNoteCardProps) {
  ...
  const [content, setContent] = useState('')
    ...
    return (
      <Dialog.Root>
        <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus:ring-lime-400 ">
                <span className="text-sm fonte-medium text-slate-200">
                  Adicionar nota
                </span>
          ...
          <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none">
            ...
            <form  className="flex-1 flex flex-col"> 
                <div className="flex flex-1 flex-col gap-3 p-5 mb-8">
                      <span className="text-sm fonte-medium text-slate-400">
                        Adicionar nota
                      </span> 
